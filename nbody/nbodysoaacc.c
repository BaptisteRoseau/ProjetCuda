...
int main(const int argc, const char** argv)
{
  ...
  particles.x[0:nParticles], particles.y[0:nParticles], particles.z[0:nParticles],\
  particles.vx[0:nParticles], particles.vy[0:nParticles], particles.vz[0:nParticles])
  {
